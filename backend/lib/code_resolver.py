...
CORE_VARIABLE_TO_CATEGORY: Dict[str, str] = {
    ...
    "Diagnosis.biopsyGrading": "Grading",
    ...
    "Surgery.surgicalSpecimenGradingOnlyInUntreatedTumours": "Grading",
    ...
    "SystemicTreatment.intent": "Intent",
